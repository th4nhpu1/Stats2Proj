...
We confirm that every group member can explain the submitted analysis. AI use is reported in `Group05_AI_Log.csv`, and the group checked every AI-assisted item used in this report.
